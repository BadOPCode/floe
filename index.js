...
var less_repository = new partyline.addLocalProcess('subs/less/index.js', function(packet){
    //display packet generated by service
    console.log("----[Less Repository "+static_repository.worker.configuration.worker_id+" Start]-----");
    console.log(JSON.stringify(packet));
    console.log("----[Less Repository "+static_repository.worker.configuration.worker_id+" End]-----");
});
